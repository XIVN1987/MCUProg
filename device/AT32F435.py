...
class AT32F435RG(object):
    ...
    def __init__(self, xlink):
        super(AT32F435RG, self).__init__()
        
        self.xlink = xlink

        self.flash = Flash(self.xlink, AT32F435RG_flash_algo)

    def sect_erase(self, addr, size):
        self.flash.Init(0, 0, 1)
        for i in range(size // self.SECT_SIZE):
            self.flash.EraseSector(0x08000000 + addr + self.SECT_SIZE * i)
        self.flash.UnInit(1)
...
class AT32F437VM(AT32F435RG):
    PAGE_SIZE = 1024 * 1
    SECT_SIZE = 1024 * 4
    CHIP_SIZE = 1024 * 4032

    def __init__(self, xlink):
        super(AT32F437VM, self).__init__(xlink)

        self.flash = Flash(self.xlink, AT32F437VM_flash_algo)


AT32F435RG_flash_algo = {
    ...
    'instructions' : [
        ...
        0x47702000, 0x20AAF64A, 0x60104A79, 0x42814879, 0x4875D22C, 0x6800300C, 0x0002F040, 0x320C4A72,
        ...
        0x1C9B8018, 0x1E891C92, 0xD1F82900, 0xBD102000, 0x42834840, 0x483CD236, 0x6800300C, 0x0001F040,
        ...
        0xE0042000, 0x45670123, 0x40023C04, 0xCDEF89AB, 0x40003000, 0x08080000, 0x00000000
    ],
    ...
    'static_base'        : 0x20000398,
    'begin_data'         : 0x2000039C,
    'begin_stack'        : 0x20000B9C,
